...
hist(long_data$log_mcp_area)
hist(long_data$mcp_area)

fit_norm <- fitdist(long_data$log_mcp_area, "norm")
fit_lnorm <- fitdist(long_data$log_mcp_area, "lnorm")
fit_gamma <- fitdist(long_data$log_mcp_area, "gamma")
fit_weibull <- fitdist(long_data$log_mcp_area, "weibull")
